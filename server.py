...
class ProviderState:
    ...
    # "No pairings available" filter (MAG-1591). Sourced from stubs_solana
    # so the field, the handler fallback, and /reset all share one number.
    # Only read by the Solana listener pool (18582-18584); ignored by every
    # other handler.
